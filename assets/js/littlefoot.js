!function (e, t) {
    ...
    var f = t(function (o) {
            ...
            !function () {
                var e,
                    r,
                    t = "object" == typeof T ? T : "object" == typeof self ? self : "object" == typeof this ? this : {};
                function n(n, r) {
                ...
                c = function (e, t, n, r) {
                    ...
                    if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) 
                        ...
                        for (var u = e.length - 1; 0 <= u; u--) 
                            (o = e[u]) && (a =( i < 3 ? o(a) : 3 < i ? o(t, n, a) : o(t, n)) || a);
                    ...
                    function t(t) {
                        return function (e) {
                            return function (t) {
                                ...
                                for (; u;) 
                                    try {
                                        if (o = 1, i && (a = 2 & t[0] ? i.return : t[0] ? i.throw || ((a = i.return) && a.call(i), 0) : i.next) && !(a = a.call(i, t[1])).done) 
                                            return a;
                ...
                x = function (e, t) {
                    return Object.defineProperty ? Object.defineProperty(e, "raw", {value: t}) : e.raw = t,
                    e
                },
                S = function (e) {
                    if (e && e.__esModule) 
                ...
                e("__spreadArrays", y),
                e("__await", g),
                e("__asyncGenerator", b),
                e("__asyncDelegator", w),
                e("__asyncValues", _),
                e("__makeTemplateObject", x),
                e("__importStar", S),
                e("__importDefault", O),
                e("__classPrivateFieldGet", E),
        ...
        i = t(function (e, t) {
            ...
            t.pixels = function e(t, n) {
                var r,
                    ...
                    u,
                    c,
                    l = null !== (o = null === (r = null == n ? void 0 : n.ownerDocument) || void 0 === r ? void 0 : r.defaultView) && void 0 !== o ? o : window,
                    s = l.document.documentElement || l.document.body,
                    f = (a = t || "0", u = parseFloat(a), c = a.match(/[\d-.]+(\w+)$/), [
                        u, (null !== (i = null == c ? void 0 : c[1]) && void 0 !== i ? i : "").toLowerCase()
                    ]),
                    d = f[0];
                switch (f[1]) {
                    case "rem":
    ...
    function O(e) {
        ...
        return {
            ...
            activate: function (e) {
                ...
                p.style.maxWidth = document.body.clientWidth + "px",
                t = d,
                h = Math.round(i.pixels(g.getStyle(t, "maxHeight"), t)),
                null != e && e(p, f)
            },
            dismiss: function (e) {
        ...
        h = function (r) {
            return function (e) {
                var t = e.currentTarget,
                    n = - e.deltaY;
                0 < n && b(r, o),
                t && n <= 0 && n < t.clientHeight + t.scrollTop - t.scrollHeight && v(r, o)
            }
        };
    ...
    function L(e) {
        var t,
            n,
            r = (t = e, n = ":not(." + j + ")", Array.from(t.children).filter(function (e) {
    ...
    var W = function (o) {
        ...
        return function (e) {
            ...
            a = r, {
                original: t,
                data: f.__assign(f.__assign({}, n), {number: i})
            }
        }
    };
    function n(e) {
    ...
    function R(e, t) {
        ...
        return function (e) {
            ...
            i.dataset.footnoteButton = "",
            i.dataset.footnoteId = r,
            i.dataset.footnoteNumber = "" + n.number;
            var a = H(f(n));
            a.dataset.footnotePopover = "",
            a.dataset.footnoteId = r;
            var u,
                c = D(a, P),
                l = D(a, E);
            return u = a,
            l.addEventListener("wheel", d.throttle(h(u), p)), {
                original: t,
                data: n,
                id: r,
                button: i,
    ...
    function q(e, n) {
        ...
        function o(e) {
            return function (t) {
                ...
                t.isReady() && (t.activate(n.activateCallback), t.reposition(), t.resize(), setTimeout(t.ready, e))
            }
        }
        function i(n) {
            return function (t) {
        ...
        return {
            ...
            hover: i(function (e) {
                e.startHovering(),
                n.activateOnHover && ! e.isActive() && o(n.hoverDelay)(e)
            }),
            unhover: i(function (e) {
                e.stopHovering(),
                n.dismissOnUnhover && setTimeout(function () {
    ...
    var r = t(function (e, t) {
            e.exports = function () {
                ...
                e.prototype.add = function (e, t) {
                    ...
                    if ("string" == typeof e) {
                        for (d[(n =
                                ...
                                selector: e,
                                data: t
                            }).id] = n, c = v(this.indexes, e), r = 0; r < c.length; r++) 
                            i = (l = c[r]).key,
                            (a = function (e, t) {
                                var n,
                                    r,
                            ...
                            }(s, o = l.index)) || ((a = Object.create(o)).map = new p, s.push(a)),
                ...
                e.prototype.remove = function (e, t) {
                    if ("string" == typeof e) {
                        for (var n, r, o, i, a, u, c = this.activeIndexes, l = this.selectors =[], s = this.selectorObjects, f =
                            {}, d = 1 === arguments.length, p = v(this.indexes, e), h = 0; h < p.length; h++) 
                            for (n = p[h], r = c.length; r--;) 
                                if (i = c[r], n.index.isPrototypeOf(i)) {
                                    if (a = i.map.get(n.key)) 
                                        for (o = a.length; o--;) 
                                            (u = a[o]).selector !== e || ! d && u.data !== t || (a.splice(o, 1), f[u.id] =! 0);
                ...
                e.prototype.queryAll = function (e) {
                    ...
                    for (var t, n, r, o, i, a, u =
                        {}, c =[], l = this.querySelectorAll(this.selectors.join(", "), e), s = 0, f = l.length; s < f; s++) 
                        for (r = l[s], t = 0, n =( o = this.matches(r)).length; t < n; t++) 
                            u[(a = o[t]).id] ? i = u[a.id] : (i =
                                { id: a.id,
                                selector: a.selector,
                                data: a.data,
                                elements: []
                ...
                e.prototype.matches = function (e) {
                    ...
                    for (var t, n, r, o, i, a, u, c, l, s = this.activeIndexes, f =
                        {}, d =[], p = 0, h = s.length; p < h; p++) 
                        if (a =( i = s[p]).element(e)) 
                            for (t = 0, r = a.length; t < r; t++) 
                                if (u = i.map.get(a[t])) 
                                    for (n = 0, o = u.length; n < o; n++) 
                                        ! f[l = (c = u[n]).id] && this.matchesSelector(e, c.selector) && (f[l] =! 0, d.push(c));
    ...
    function ee(e) {
        ...
        return {
            activate: function (e, t) {
                void 0 === t && (t = c.activateDelay),
                l.activate(e, t)
            },
            dismiss: function (e, t) {
                void 0 === t && (t = c.dismissDelay),
                void 0 === e ? l.dismissAll() : l.dismiss(e, t)
            },
            unmount: function () {
                s(),
                l.unmount()
